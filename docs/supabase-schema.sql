...
alter table sales_leads add column if not exists menu_count integer;
alter table sales_leads add column if not exists monthly_price integer;
alter table sales_leads add column if not exists term_original_price integer;
alter table sales_leads add column if not exists term_discount_rate numeric(5,2);
alter table sales_leads add column if not exists term_final_price integer;
